    ...
    <div ref={containerRef} className="relative flex items-center justify-center">
      <div
        className={cn(
          ...
          open ? 'w-[min(380px,85vw)] max-w-[380px] opacity-100' : 'w-10 opacity-100'
        )}
      >
        {open ? (
          <>
            ...
            <Input
              ...
              className="h-10 rounded-xl border-primary/20 bg-slate-50 pl-9 pr-9 focus-visible:ring-2 focus-visible:ring-primary/30"
            />
          ...
          <Button
            ...
            variant="outline"
            size="icon"
            className="h-10 w-10 rounded-full border-primary/20 bg-white"
